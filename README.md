...
本地工作机没有 Android SDK；请以 [GitHub Actions 构建结果](https://github.com/flik6/shadowsocks-ssh-relay/actions/workflows/android.yml) 为准。APK 已由 Actions 编译并上传，但仍需在实际安卓设备上验证运行和网络转发。
